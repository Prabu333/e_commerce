...
useEffect(()=>{
  ...
  const submitHandler =(e) =>{
    ...
    const revieuserName = reviewUser.current.value
    const revieuserMsg = reviewMsg.current.value

    const reviewObj ={
      userName : revieuserName,
      text : revieuserMsg,
      rating
    }
          ...
          <Row>
            ...
            <Col lg='6'>
              <div className="product__details">
                ...
                <span>Cateogry : {category? category.toUpperCase() : null}</span>
                </div>
